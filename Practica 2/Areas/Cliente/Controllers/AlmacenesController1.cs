...
namespace Practica_2.Areas.Cliente.Controllers
{
    [Area("Admin")]
    public class AlmacenesController1 : Controller
    {
        private readonly IContenedorTrabajo _contenedorTrabajo;

        public AlmacenesController1(IContenedorTrabajo contenedorTrabajo)
        {
